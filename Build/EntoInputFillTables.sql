...
EXEC AddIndividual @GivenGenusName = 'Lagria',
				...
				@GivenDeterminedBy = 'Rik Wouters',
				@GivenDeterminationDate = '2018-05-17',
				@GivenYcoor = 52.437685,
				@GivenXcoor = 4.539898,
				@GivenLocalityName = 'Rivier',
				@GivenSamplingDate = '2018-04-18'
...
EXEC AddDetermination @GivenIndividualID = 3,
						@GivenGenusName = 'Lagria',
						@GivenSpeciesName = 'atripes',
						@GivenDeterminedBy = 'Rik Wouters',
						@GivenDeterminationDate = '2018-06-23'
GO
